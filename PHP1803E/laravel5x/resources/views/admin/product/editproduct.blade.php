	...
	<div class="row">
		<div class="col-md-6">
			...
			<div class="form-group">
				...
				<select class="form-control" name="catid" id="slcCat">
					...
					<option value="{{$cat->id}}" {{$cat->id == $info->catid ? 'selected' : ''}}>{{$cat->namecat}}</option>
					@endforeach
				</select>
			...
			<div class="form-group">
				...
				<select class="form-control" name="sizeid" id="slcSize">
					...
					<option value="{{ $size->id }}" {{ $size->id == $info->sizeid ? 'selected' : ''}}>{{ $size->namesize }}</option>
					@endforeach
				</select>
		...
		<div class="col-md-6">
			...
			<div class="form-group">
				...
				<img src="{{ asset('uploads/images/'.$info->imagepd)}}" alt="" width="120" height="120">
			</div>
			<div class="form-group">
